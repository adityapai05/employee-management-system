...
function TaskList({ data }) {
  ...
  return (
    <div
      id="task-list"
      className="flex items-center justify-start gap-5 h-[60%] sm:h-[60%] md:h-[60%] lg:h-[60%] xl:h-[60%] w-full mt-5  rounded-xl py-5 flex-nowrap overflow-x-auto scrollbar-hide"
    >
